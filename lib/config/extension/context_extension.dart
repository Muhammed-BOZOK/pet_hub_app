...
extension MediaQueryExtension on BuildContext {
  ...
  /// Returns 60% of the screen height
  double get veryhighValue6x => height * 0.6;
...
extension MarginExtension on BuildContext {
    ...
    /// Adds 1% padding from top.
  EdgeInsets get marginTopLow => EdgeInsets.only(top: lowValue);

  /// Adds 2% padding from top.
  /// Use this when you want to add padding from top.
  EdgeInsets get marginTopDefault => EdgeInsets.only(top: defaultValue);

  /// Adds 5% padding from top.
  EdgeInsets get marginTopHigh => EdgeInsets.only(top: highValue);

  /// Adds 1% padding from bottom.
  EdgeInsets get marginBottomLow => EdgeInsets.only(bottom: lowValue);

  /// Adds 2% padding from bottom.
  /// Use this when you want to add padding from bottom.
  EdgeInsets get marginBottomDefault => EdgeInsets.only(bottom: defaultValue);

  /// Adds 5% padding from bottom.
  EdgeInsets get margnBottomHigh => EdgeInsets.only(bottom: highValue);
